...
for filename in os.listdir('C:/Users/Austin/Downloads/FoodData_Central_csv_2024-10-31/FoodData_Central_csv_2024-10-31'):
    if filename.endswith('.csv'):  # if it's a CSV file
        process_csv(os.path.join('C:/Users/Austin/Downloads/FoodData_Central_csv_2024-10-31/FoodData_Central_csv_2024-10-31', filename))
