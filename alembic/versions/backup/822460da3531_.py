...
# Revision ID: 822460da3531
# Revises: dddceb6761a9
# Create Date: 2024-11-06 23:21:13.848412
...
#     sa.PrimaryKeyConstraint('fdc_id')
#     )
#     op.create_table('fndds_derivation',
...
#     sa.Column('food_group_id', sa.Integer(), nullable=True),
#     sa.Column('description', sa.String(), nullable=True),
...
#     sa.PrimaryKeyConstraint('fdc_id'),
#     sa.UniqueConstraint('NDB_number')
#     )
...
#     sa.Column('food_attribute_type_id', sa.Integer(), nullable=True),
#     sa.Column('name', sa.String(), nullable=True),
#     sa.Column('value', sa.String(), nullable=True),
#     sa.ForeignKeyConstraint(['food_attribute_type_id'], ['food_attribute_type.id'], ),
#     sa.PrimaryKeyConstraint('id')
#     )
...
#     sa.Column('derivation_id', sa.String(), nullable=True),
...
#     sa.ForeignKeyConstraint(['derivation_id'], ['fndds_derivation.derivation_code'], ),
...
#     sa.Column('id', sa.Integer(), nullable=False),
#     sa.Column('fdc_id', sa.Integer(), nullable=True),
#     sa.Column('fdc_id_of_input_food', sa.Integer(), nullable=True),
#     sa.Column('seq_num', sa.Integer(), nullable=True),
#     sa.Column('amount', sa.Float(), nullable=True),
#     sa.Column('sr_code', sa.Integer(), nullable=True),
#     sa.Column('sr_description', sa.String(), nullable=True),
#     sa.Column('unit', sa.String(), nullable=True),
#     sa.Column('portion_code', sa.Integer(), nullable=True),
#     sa.Column('portion_description', sa.String(), nullable=True),
#     sa.Column('gram_weight', sa.Float(), nullable=True),
#     sa.Column('retention_code', sa.Integer(), nullable=True),
#     sa.ForeignKeyConstraint(['retention_code'], ['retention_factor.code'], ),
#     sa.ForeignKeyConstraint(['sr_code'], ['sr_legacy_food.NDB_number'], ),
#     sa.PrimaryKeyConstraint('id')
#     )
...
#     sa.Column('code', sa.String(), nullable=True),
#     sa.ForeignKeyConstraint(['lab_method_id'], ['lab_method.id'], ),
#     sa.PrimaryKeyConstraint('id')
#     )
...
#     sa.ForeignKeyConstraint(['wweia_category_code'], ['wweia_food_category.wweia_food_category'], ),
#     sa.PrimaryKeyConstraint('fdc_id')
#     )
#     op.create_table('sub_sample_result',
#     sa.Column('id', sa.Integer(), nullable=False),
#     sa.Column('food_nutrient_id', sa.Integer(), nullable=True),
